...
user in an INI file next to PasswordSafePortable.exe called PasswordSafePortable.ini.
...
copy AppNamePortable.ini from this directory to PasswordSafePortable.ini next to
PasswordSafePortable.exe. The options in the INI file are as follows:
